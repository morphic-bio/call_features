...
MTX_DIR="/storage/test_features/${SC_ID}"
STARSOLO_DIR="/mnt/pikachu/storage/MSK-output-2/Alignments/${SC_ID}/star/Solo.out/Gene"
OUT_PREFIX="/mnt/pikachu/storage/MSK-output-2/Alignments/${SC_ID}/star/larry_${METHOD}"
...
case "$METHOD" in
    ...
    "simple")
        ...
        CMD+=(--simple-assign
              ...
              --m-min-fixed 5)
        echo "Note: This method uses a fixed M_min of 5"
        ;;
    "em-cells")
